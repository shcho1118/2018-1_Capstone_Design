    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, resultData: Intent?) {
        ...
        if (requestCode == REQUEST_SCREENSHOT) {
            if (resultCode == RESULT_OK) {
                var testIntent = Intent(applicationContext, CaptureService::class.java)
                        .putExtra(ProjectorService.EXTRA_RESULT_CODE, resultCode)
                        .putExtra(ProjectorService.EXTRA_RESULT_INTENT, resultData)
