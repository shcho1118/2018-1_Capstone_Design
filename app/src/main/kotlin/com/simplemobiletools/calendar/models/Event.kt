...
data class Event(var id: Int = 0, var startTS: Int = 0, var endTS: Int = 0, var title: String = "", var description: String = "",
                 ...
                 var check_location: Int = 0, var category: String = "", var isFinished: Boolean = false,
                 var locat_latitude: String = "", var locat_longitude: String = "", var delay_time: Int = 0, var delay_time2: Int = 0) : Serializable {
